...
## Project Structure
    ...
    ├── django_ecommerce_de_29831  # Django project configurations
...
1. Clone this repo and `cd django_ecommerce_de_29831`
...
2. Clone this repo and `cd django_ecommerce_de_29831`
